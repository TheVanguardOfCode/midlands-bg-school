import { getLocalStorageData, setLocalStorageData, } from "../utils/local-storage-util.js";
import { locales, dataI18n, langString, defaultLanguage, } from "../utils/i18n-util.js";
...
const detectLanguage = () => {
    ...
    const langFromSettings = (navigator.language || navigator.userLanguage).slice(0, 2);
